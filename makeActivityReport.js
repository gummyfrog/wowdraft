...
var league_code = "85e7cbab-bbc6-4f43-991e-4944b39676ac";

axios.get(`https://wowdraft.herokuapp.com/api/leagues/${league_code}/teams`)
.then((res) => {
	var teams_done = 0;
	var processed = [];
	for(var x=0; x<res.data.length;x++)	{
		...
		fetcher.on("done", (data) => {
			...
			if(teams_done == res.data.length) {
				...
				axios.post(`https://wowdraft.herokuapp.com/api/leagues/${league_code}/activity_report`, {
					data: processed
				})
				.then((res) => {
					console.log(res);
